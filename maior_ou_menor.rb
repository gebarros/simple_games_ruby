...
def sorteia_numero_secreto(dificuldade)
    ...
    puts "\n\nEscolhendo um número secreto entre 1 a #{maximo}...\n\n"
    sorteado = rand(maximo) + 1
    puts "Escolhido... que tal adivinhar hoje nosso número secreto?\n\n"
    sorteado
end

def pede_um_numero(chutes, tentativa, n_tentativa)
    puts "\n\n\n"
    puts "Tentativa #{tentativa} de #{n_tentativa}"
...
def joga(nome, dificuldade)
    ...
    for tentativa in 1..n_tentativa
        chute = pede_um_numero chutes, tentativa, n_tentativa
        chutes << chute
